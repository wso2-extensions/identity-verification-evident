 ...
 * under the License.
 */
package org.wso2.carbon.identity.verification.evident.constants;

public class EvidentIDVConstants {
    ...
    public static final String EVIDENT_USER_STORES = "evidentVerify.userstores";
